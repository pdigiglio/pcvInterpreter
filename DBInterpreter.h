...
private:
	...
	DBTable<CAL_ID, const call_t*> callT_;
	DBTable<FIL_ID, const file_t*> fileT_;
	DBTable<FUN_ID, const function_t*> functionT_;
	DBTable<INS_ID, const instruction_t*> instructionT_;
	DBTable<LOP_ID, const loop_t*> loopT_;
    DBTable<LOE_ID, const loopExecution_t*> loopExecutionT_;
	DBTable<REF_ID, const reference_t*> referenceT_;
	DBTable<LOI_ID, const loopIteration_t*> loopIterationT_;
	DBTable<SEG_ID, const segment_t*> segmentT_; 
	DBTable<INS_ID, const thread_t*> threadT_;
